...
class CocoEvalFor200(COCOeval):
    def __init__(self, cocoGt=None, cocoDt=None, iouType='bbox'):
        super(CocoEvalFor200, self).__init__(cocoGt,cocoDt,'bbox')
    def summarize(self):
        '''
...
class COCOeval_opt(CocoEvalFor200):
    """
...
cocoGt = COCO('/root/sku/SKU110K_fixed/annotations/test.json')  
cocoDt = cocoGt.loadRes("/root/RPC/rpc_exp/ResNeSt/d2/output_result/coco_instances_results.json")
